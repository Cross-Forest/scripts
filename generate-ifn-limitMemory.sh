...
./sparql-generate.sh -q ../sparql-generate/ifn/parcelas_exs.rqg -i tables/parcelas_exs.csv -v -s 100000
...
./sparql-generate.sh -q ../sparql-generate/ifn/pcmayores.rqg -i tables/pcmayores.csv -v -s 100000
...
java -Xmx18000M -jar /usr/local/lib/epsgrdf-1.1-SNAPSHOT-jar-with-dependencies.jar tables/pcdatosmap.ttl tables/pcespparc.ttl tables/pcmayores.ttl ../Ontologies/epsg/Coordinate_Reference_System.ttl
